...
import { getCdpDefaultSchemes, getCdpExtensionRegistrations, CDP_SUPPORTED_EXTENSIONS, CDP_EXTENSION_BAZAAR, CDP_EXTENSION_BUILDER_CODE, buildBazaarDeclaration, } from "./server-extensions.js";
...
export class X402Server extends x402HTTPResourceServer {
    ...
    static async create(config) {
         ...
         */
        const builderCodeDeclaration = declareServerBuilderCodeExtension(merged.builderCode);
