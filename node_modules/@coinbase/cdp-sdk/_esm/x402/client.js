...
import { cdpSolanaAccountToSvmSigner, fromCdpEvmAccount, fromCdpSmartWallet, } from "./account-signers.js";
    ...
    for (const [network, netConfig] of networksByName) {
        ...
        if (netConfig.scheme.exact) {
            if (isSolana) {
                ...
                client.registerV1(network, new ExactSvmSchemeV1(svmSigner, { rpcUrl: netConfig.rpcUrl }));
            }
            else {
                client.register(caip2Network, new ExactEvmScheme(evmSigner, evmRpcUrlsByChainId));
                client.registerV1(network, new ExactEvmSchemeV1(evmSigner));
            }
        }
        ...
        if (netConfig.scheme.batchSettlement) {
            if (isSolana) {
                ...
                client.register(caip2Network, new BatchSettlementEvmScheme(evmSigner, { rpcUrl: netConfig.rpcUrl }));
            }
        }
    }
