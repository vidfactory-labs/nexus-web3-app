...
exports.CDP_SUPPORTED_EXTENSIONS = exports.CDP_EXTENSION_BUILDER_CODE = exports.CDP_EXTENSION_BAZAAR = exports.CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL = exports.CDP_EXTENSION_GAS_SPONSORING_EIP2612 = void 0;
 ...
 */
exports.CDP_EXTENSION_BUILDER_CODE = builder_code_1.BUILDER_CODE;
/*
 * ---------------------------------------------------------------------------
...
function getCdpDefaultSchemes() {
    return [
        { network: "eip155:*", server: new server_1.ExactEvmScheme() },
        { network: "eip155:*", server: new server_2.UptoEvmScheme() },
        { network: "solana:*", server: new server_3.ExactSvmScheme() },
    ];
}
/*
 * ---------------------------------------------------------------------------
...
function getCdpExtensionRegistrations() {
    return [
        ...
        builder_code_1.builderCodeResourceServerExtension,
    ];
}
