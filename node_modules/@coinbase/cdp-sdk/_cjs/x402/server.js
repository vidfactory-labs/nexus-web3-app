 ...
 */
function withAutoInjectedExtensions(pattern, route, builderCode) {
    const bazaar = parseRouteKeyForBazaar(pattern);
    const hasEvmAccept = routeHasEvmAccept(route);
    return {
        ...route,
        extensions: {
            ...(hasEvmAccept && server_extensions_js_1.CDP_SUPPORTED_EXTENSIONS),
            ...
            ...(builderCode && hasEvmAccept && { [server_extensions_js_1.CDP_EXTENSION_BUILDER_CODE]: builderCode }),
            ...route.extensions,
        },
    };
}
 ...
 */
function resolveRoutes(routes, evmAddress, svmAddress, environment, builderCode) {
    const result = {};
...
class X402Server extends server_1.x402HTTPResourceServer {
    ...
    static async create(config) {
        ...
        if (merged.builderCode !== undefined) {
            (0, builder_code_js_1.assertBuilderCode)(merged.builderCode);
        }
        /*
         ...
         */
        const builderCodeDeclaration = (0, builder_code_js_1.declareServerBuilderCodeExtension)(merged.builderCode);
        ...
        const resolvedRoutes = resolveRoutes(routes, evmAddress, svmAddress, environment, builderCodeDeclaration);
