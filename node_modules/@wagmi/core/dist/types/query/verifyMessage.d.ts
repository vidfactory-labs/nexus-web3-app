...
export type VerifyMessageOptions<config extends Config, selectData = VerifyMessageData> = Compute<UnionExactPartial<VerifyMessageParameters<config>> & ScopeKeyParameter> & QueryParameter<VerifyMessageQueryFnData, VerifyMessageErrorType, selectData, VerifyMessageQueryKey<config>>;
...
export declare function verifyMessageQueryKey<config extends Config>(options?: Compute<UnionExactPartial<VerifyMessageParameters<config>> & ScopeKeyParameter>): readonly ["verifyMessage", {
    ...
    requireCanonical?: boolean | undefined | undefined;
    ...
    mode?: "auto" | "eoa" | (string & {}) | undefined | undefined;
