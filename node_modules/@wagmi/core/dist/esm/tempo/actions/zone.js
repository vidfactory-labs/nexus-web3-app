 ...
 */
export function waitForTempoBlock(config, parameters) {
    const { chainId, ...rest } = parameters;
    const client = config.getClient({ chainId });
    return Actions.zone.waitForTempoBlock(client, rest);
}
(function (waitForTempoBlock) {
    function queryKey(parameters) {
        return ['waitForTempoBlock', filterQueryOptions(parameters)];
    }
    waitForTempoBlock.queryKey = queryKey;
    function queryOptions(config, parameters) {
        const { query, ...rest } = parameters;
        return {
            ...query,
    ...
    waitForTempoBlock.queryOptions = queryOptions;
})(waitForTempoBlock || (waitForTempoBlock = {}));
/**
...
export async function deposit(config, parameters) {
    ...
    const { amount, bouncebackRecipient = accountAddress, memo = zeroHash, recipient = accountAddress, token, zoneId, ...tx } = rest;
...
export async function encryptedDeposit(config, parameters) {
    ...
    const { amount, memo, recipient = accountAddress, token, zoneId, ...tx } = rest_;
