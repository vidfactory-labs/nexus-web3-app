 ...
 */
export declare function handleRequest(next: handleRequest.Handler, parameters: handleRequest.Parameters): handleRequest.Handler;
export declare namespace handleRequest {
    /** RPC request handler. */
    type Handler = (request: Request, options?: EIP1193RequestOptions | undefined) => Promise<unknown>;
    ...
    type ErrorType = ConfigStore.InvalidStoreValueError | OperationStore.InvalidStoreValueError | OperationStore.StoreConflictError | RpcResponse.InvalidParamsError;
}
